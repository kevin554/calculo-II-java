...
public class PanelCoordenadas extends JPanel {
    ...
    /**
     * La mitad del tamaño de un punto de Interseccion
     */
    private final int mitadPunto = 4;
    /**
     * La Ecuacion a graficar
     */
    private Ecuacion punto;

    public PanelCoordenadas() {
    }
    
    public PanelCoordenadas(Ecuacion elPunto) {
        punto = elPunto;
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (punto != null)
            punto.graficarEcuacion(g, this);
    }

    /**
     * Por defecto, El origen se encuentra en (320, 320) Para dibujar el punto
    ...
    public void dibujarSistemaDeCoordenadas(Graphics g) {
        ...
        gTemp.setFont(new Font("Winner", Font.BOLD, 16));
        gTemp.drawString("WINNER", getWidth() - 80, getHeight() - 20);
        ...
        g.fillOval(distanciaHorizontalAlOrigen() - mitadPunto, distanciaVerticalAlOrigen() - mitadPunto, 8, 8);
        
        //SEGMENTOS DEL EJE X   
        gTemp.setStroke(new BasicStroke(2.6f));
        //Del centro a la izquierda
        for (int i = distanciaHorizontalAlOrigen() - margen; i >= margen; i -= margen)          
            gTemp.drawLine(i, distanciaVerticalAlOrigen() - 5, i, distanciaVerticalAlOrigen() + 5);
        ...
        //Del centro hacia arriba
        for (int i = distanciaVerticalAlOrigen() - margen; i > 0; i -= margen) 
            gTemp.drawLine(distanciaHorizontalAlOrigen() - 5, i, distanciaHorizontalAlOrigen() + 5, i);
    ...
    /**
     * Dibuja una flecha desde el Origen hasta el punto especificado
    ...
    /**
     * Devuelve la mitad del tamaño de un punto de interseccion
     * Por defecto es 4
     * @return 
     */
